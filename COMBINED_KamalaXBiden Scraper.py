...
def collection(url, state, type, year):
    ...
    def clean_data(df, type, year):
            ...
            #df = df.drop(['finalR', 'finalD'], axis=1)
    ...
    elif type in ["national", "president","national_Biden","president_Biden","national_Kamala","president_Kamala"]:
        #print("json")
        #print()
...
master_url = {
    "2024":{
        ...
        "national_Kamala":{
            "national":"https://www.realclearpolling.com/polls/president/general/2024/trump-vs-harris"
        },
        "president_Kamala":{
            #"Alabama":"",
            #"Alaska": "",
...
all_df = all_df.drop(['finalR', 'finalD'], axis=1)

z = random.randrange(6, 100)
filename = "C:/Users/lukem/Documents/C files/RCP SCRAPERS/Biden_Kamala_attempted_combine_8.13.24_V2.csv"
