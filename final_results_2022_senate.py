...
def get_senate2022_data(url, state):
    ...
    if page.status_code == 200:
        ...
        ivalue_pattern1 = r'"candidate":\[{[^}]*},{"name":"([^"]*?)","affiliation":"Independent","value":"([^"]*)"'
        ivalue_pattern2 = r'"candidate":\[{"name":"([^"]*?)","affiliation":"Independent","value":"([^"]*)"'
        ...
        ivalue_data = re.findall(ivalue_pattern1, x) or re.findall(ivalue_pattern2, x)
        ...
        data_rows = []
        for row in zip_longest(pollster_data, date_data, sample_size_data, margin_error_data, dvalue_data, rvalue_data, ivalue_data, final_rvalue_data, final_dvalue_data, final_ivalue_data, fillvalue=None):
            data_rows.append({
